# 6_treeview_w_row_index
Modified example of the original 6_treeview.py file from Qt's Model View Tutorial Examples
https://doc.qt.io/qtforpython-6/examples/example_widgets_tutorials_modelview.html#example-widgets-tutorials-modelview
